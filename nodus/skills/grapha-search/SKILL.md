...
- Before rewriting call sites or migrating a type, use `find_usages` / `grapha symbol usages` to get grouped usage sites. Add `exclude_files` / `--exclude` for generated wrappers or module export files.
